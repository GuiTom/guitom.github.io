...
, function(t, o, n) {
    ...
    function e(t) {
        ...
        s.each(t.options.actions, function(o, n) {
            var r = !1;
            s.each(t.options.actionsGroups, function(t, o) {
                s.contains(t, n) && (e[o + 1].push(n),
                r = !0)
            }),
            r === !1 && e[0].push(n),
            "undefined" != typeof o.iconClass && (i = !0)
        });
        var r = !0;
        return s.each(e, function(o) {
            0 != o.length && (r === !1 && n.append('<li class="divider"></li>'),
            r = !1,
            s.each(o, function(o) {
    ...
    u.prototype.open = function(t, o) {
        ...
        this.$menu.on("click.BootstrapMenuAction", function(o) {
            o.preventDefault();
            var e = c(o.target);
...
, function(t, o, n) {
    function e(t) {
        ...
        var o = t.length;
        o = o && c(o) && (r(t) || i(t)) && o || 0;
        for (var n = t.constructor, e = -1, u = "function" == typeof n && n.prototype === t, f = Array(o), p = o > 0; ++e < o; )
            f[e] = e + "";
        for (var h in t)
            p && s(h, o) || "constructor" == h && (u || !a.call(t, h)) || f.push(h);
        return f
    }
    var i = n(23)
      , r = n(24)
...
, function(t, o, n) {
    function e(t, o) {
        return function(n, e) {
            ...
            if (!r(c))
                return t(n, e);
            for (var l = o ? c : -1, u = s(n); (o ? l-- : ++l < c) && e(u[l], l, u) !== !1; )
                ;
            return n
        }
    }
...
, function(t, o, n) {
    function e(t, o, n, e) {
        ...
        return l(p) || (t = a(t),
        p = t.length),
        n = "number" != typeof n || e && c(o, n, e) ? 0 : 0 > n ? f(p + n, 0) : n || 0,
        "string" == typeof t || !s(t) && u(t) ? p >= n && t.indexOf(o, n) > -1 : !!p && i(t, o, n) > -1
    }
    var i = n(33)
      , r = n(19)
      , s = n(24)
...
, function(t, o) {
    function n(t, o) {
        for (var n = -1, e = o.length, i = Array(e); ++n < e; )
            i[n] = t[o[n]];
        return i
    }
    t.exports = n
    ...
    function e(t) {
        return s(function(o, n) {
            var e = -1
              ...
              , l = s > 2 ? n[2] : void 0
              , u = s > 1 ? n[s - 1] : void 0;
            for ("function" == typeof c ? (c = i(c, u, 5),
            s -= 2) : (c = "function" == typeof u ? u : void 0,
            s -= c ? 1 : 0),
            l && r(n[0], n[1], l) && (c = 3 > s ? void 0 : c,
            s = 1); ++e < s; ) {
                var a = n[e];
                a && t(o, a, c)
            }
...
, function(t, o) {
    function n(t, o) {
        ...
        function() {
            for (var n = arguments, e = -1, r = i(n.length - o, 0), s = Array(r); ++e < r; )
                s[e] = n[o + e];
            switch (o) {
            case 0:
...
, function(t, o, n) {
    ...
    !function(t, o) {
        ...
        t.ui = t.ui || {};
        var r, s = Math.max, c = Math.abs, l = Math.round, u = /left|center|right/, a = /top|center|bottom/, f = /[\+\-]\d+(\.[\d]+)?%?/, p = /^\w+/, h = /%$/, d = t.fn.position;
        t.position = {
            scrollbarWidth: function() {
                if (r !== o)
                    return r;
                var n, e, i = t("<div style='display:block;position:absolute;width:50px;height:50px;overflow:hidden;'><div style='height:100px;width:auto;'></div></div>"), s = i.children()[0];
                return t("body").append(i),
                n = s.offsetWidth,
                i.css("overflow", "scroll"),
                e = s.offsetWidth,
                n === e && (e = i[0].clientWidth),
                i.remove(),
                r = n - e
            },
        ...
        t.fn.position = function(o) {
            ...
            o = t.extend({}, o);
            var r, h, v, m, g, y, w = t(o.of), x = t.position.getWithinInfo(o.within), b = t.position.getScrollInfo(x), W = (o.collision || "flip").split(" "), k = {};
            return y = i(w),
            ...
            t.each(["my", "at"], function() {
                ...
                1 === e.length && (e = u.test(e[0]) ? e.concat(["center"]) : a.test(e[0]) ? ["center"].concat(e) : ["center", "center"]),
                e[0] = u.test(e[0]) ? e[0] : "center",
                e[1] = a.test(e[1]) ? e[1] : "center",
                t = f.exec(e[0]),
                n = f.exec(e[1]),
                k[this] = [t ? t[0] : 0, n ? n[0] : 0],
                o[this] = [p.exec(e[0])[0], p.exec(e[1])[0]]
            }),
            1 === W.length && (W[1] = W[0]),
            "right" === o.at[0] ? g.left += h : "center" === o.at[0] && (g.left += h / 2),
            "bottom" === o.at[1] ? g.top += v : "center" === o.at[1] && (g.top += v / 2),
            r = n(k.at, h, v),
            g.left += r[0],
            g.top += r[1],
            this.each(function() {
                var i, u, a = t(this), f = a.outerWidth(), p = a.outerHeight(), d = e(this, "marginLeft"), y = e(this, "marginTop"), $ = f + d + e(this, "marginRight") + b.width, E = p + y + e(this, "marginBottom") + b.height, H = t.extend({}, g), M = n(k.my, a.outerWidth(), a.outerHeight());
                "right" === o.my[0] ? H.left -= f : "center" === o.my[0] && (H.left -= f / 2),
                "bottom" === o.my[1] ? H.top -= p : "center" === o.my[1] && (H.top -= p / 2),
                H.left += M[0],
                H.top += M[1],
                t.support.offsetFractions || (H.left = l(H.left),
                H.top = l(H.top)),
                i = {
                    marginLeft: d,
                    marginTop: y
                ...
                o.using && (u = function(t) {
                    ...
                    f > h && c(n + e) < h && (l.horizontal = "center"),
                    p > v && c(i + r) < v && (l.vertical = "middle"),
                    s(c(n), c(e)) > s(c(i), c(r)) ? l.important = "horizontal" : l.important = "vertical",
        ...
        t.ui.position = {
            fit: {
                left: function(t, o) {
                    var n, e = o.within, i = e.isWindow ? e.scrollLeft : e.offset.left, r = e.width, c = t.left - o.collisionPosition.marginLeft, l = i - c, u = c + o.collisionWidth - r - i;
                    o.collisionWidth > r ? l > 0 && 0 >= u ? (n = t.left + l + o.collisionWidth - r - i,
                    t.left += l - n) : u > 0 && 0 >= l ? t.left = i : l > u ? t.left = i + r - o.collisionWidth : t.left = i : l > 0 ? t.left += l : u > 0 ? t.left -= u : t.left = s(t.left - c, t.left)
                },
                top: function(t, o) {
                    var n, e = o.within, i = e.isWindow ? e.scrollTop : e.offset.top, r = o.within.height, c = t.top - o.collisionPosition.marginTop, l = i - c, u = c + o.collisionHeight - r - i;
                    o.collisionHeight > r ? l > 0 && 0 >= u ? (n = t.top + l + o.collisionHeight - r - i,
                    t.top += l - n) : u > 0 && 0 >= l ? t.top = i : l > u ? t.top = i + r - o.collisionHeight : t.top = i : l > 0 ? t.top += l : u > 0 ? t.top -= u : t.top = s(t.top - c, t.top)
                }
            },
            flip: {
                left: function(t, o) {
                    var n, e, i = o.within, r = i.offset.left + i.scrollLeft, s = i.width, l = i.isWindow ? i.scrollLeft : i.offset.left, u = t.left - o.collisionPosition.marginLeft, a = u - l, f = u + o.collisionWidth - s - l, p = "left" === o.my[0] ? -o.elemWidth : "right" === o.my[0] ? o.elemWidth : 0, h = "left" === o.at[0] ? o.targetWidth : "right" === o.at[0] ? -o.targetWidth : 0, d = -2 * o.offset[0];
                    0 > a ? (n = t.left + p + h + d + o.collisionWidth - s - r,
                    (0 > n || n < c(a)) && (t.left += p + h + d)) : f > 0 && (e = t.left - o.collisionPosition.marginLeft + p + h + d - l,
                    (e > 0 || c(e) < f) && (t.left += p + h + d))
                },
                top: function(t, o) {
                    var n, e, i = o.within, r = i.offset.top + i.scrollTop, s = i.height, l = i.isWindow ? i.scrollTop : i.offset.top, u = t.top - o.collisionPosition.marginTop, a = u - l, f = u + o.collisionHeight - s - l, p = "top" === o.my[1], h = p ? -o.elemHeight : "bottom" === o.my[1] ? o.elemHeight : 0, d = "top" === o.at[1] ? o.targetHeight : "bottom" === o.at[1] ? -o.targetHeight : 0, v = -2 * o.offset[1];
                    0 > a ? (e = t.top + h + d + v + o.collisionHeight - s - r,
                    t.top + h + d + v > a && (0 > e || e < c(a)) && (t.top += h + d + v)) : f > 0 && (n = t.top - o.collisionPosition.marginTop + h + d + v - l,
                    t.top + h + d + v > f && (n > 0 || c(n) < f) && (t.top += h + d + v))
                }
            },
            flipfit: {
                left: function() {
        ...
        function() {
            var o, n, e, i, r, s = document.getElementsByTagName("body")[0], c = document.createElement("div");
